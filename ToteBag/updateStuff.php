  ...
  <input type="checkbox" name="chkMovies" id="chkMovies" 
      ...
      <tr>
        <td colspan="2"><blockquote>
             ...
             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
             <input name="btnSubmit" type="submit" class="button" id="btnSubmit" value="Update Now"   />
